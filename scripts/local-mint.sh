...
dfx canister call ckusdc_ledger icrc1_balance_of '(record {owner= principal "5g24m-kxyrd-yb7wl-up5k6-4egww-miul7-gajat-e2d7i-mdpc7-6dduf-eae"})' --identity default
