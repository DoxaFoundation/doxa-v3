...
import { idlFactory } from './stablecoin_minter.did.js';
export { idlFactory } from './stablecoin_minter.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_STABLECOIN_MINTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./stablecoin_minter.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the stablecoin_minter canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./stablecoin_minter.did.js")._SERVICE>}
 */
export const stablecoin_minter = createActor(canisterId);
